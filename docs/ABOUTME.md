# 👨‍💻 About Me – Portafolio 2025

**📅 Última actualización:** Noviembre 2025  
**🧭 Estado:** Versión mejorada completa (v1.1)

---

## 🧩 Perfil Profesional – versión mejorada (v1.1)

Soy **Bernard**, Ingeniero Eleactrónico con enfoque en **desarrollo embebido, automatización y sistemas distribuidos**.  
...
| **Dev / Productivity Tools** | Git (control consciente de estados) · VSCode · Cursor IDE · Obsidian · Notion · Garuda Linux · Hyprland · Fish Shell · Starship       |
...
### 🔧 Sistemas IoT y Protocolos de Comunicación

Diseño e implementación de **sistemas distribuidos de sensores y nodos inteligentes**, utilizando microcontroladores y arquitecturas minimalistas **tipo edge** que permiten centralizar y procesar datos eficientemente.
...
Diseño de **dashboards y sitios técnicos** orientados a **visualización de datos provenientes de sistemas distribuidos**.  
Automatización de flujos y despliegues con scripts personalizados, manteniendo eficiencia y reproducibilidad en entornos Linux.
...
**SO:** Garuda Linux x86_64 · Hyprland  
**Terminal:** Fish 4.1.2 + Foot 1.25  
**Hardware:** AMD Ryzen 5 5600G · Radeon Vega · 16GB RAM  
**Temas:** Sweet (Qt) · BeautyLine (GTK)  
...
🔗 **LinkedIn:** [linkedin.com/in/bernard-dev](https://linkedin.com/in/bernard-dev)  
💾 **GitHub:** [https://github.com/MarcosBernardC](https://github.com/MarcosBernardC)  
...
**Estado del documento:** ✅ Completado (v1.1 estable)  
